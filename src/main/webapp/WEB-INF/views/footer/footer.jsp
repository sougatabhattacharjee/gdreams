    ...
    <footer id="footer" class="clear">
        ...
        <div class="one_quarter">
            ...
            <ul class="social-icons icon-circle icon-zoom list-unstyled list-inline">
                <li><a href="${contactFacebook}" target="_blank"><i class="fa fa-facebook"></i></a></li>
                <li><a href="${contactGoogleplus}"  target="_blank"><i class="fa fa-google-plus"></i></a></li>
                <li><a href="${contactTwitter}"  target="_blank"><i class="fa fa-twitter"></i></a></li>
                <li><a href="${contactLinkedin}" target="_blank"><i class="fa fa-linkedin"></i></a></li>
            </ul>
